...
public class googleplay {
	...
	public static String currentDirectory=System.getProperty("user.dir");
		...
		static void googlerunworkflow() throws IOException
		  {
			...
			try {
				   ...
				   for(int x = 1; x < 4; x = x + 1) {
						ArrayList<String> readworkflowfile = readfile.readworkflowkey();
				         ThreadLocalRandom randomworkflow = ThreadLocalRandom.current();
				         int workflow = randomworkflow.nextInt(0, readworkflowfile.size()-1); 
					     System.out.print("value of x : " + x );
				         System.out.print("\n");
						 ...
						 ele31.clear();
						 //ele31.sendKeys("abap on hana training");
						 ele31.sendKeys(readworkflowfile.get(workflow));
						 WebDriverWait w = new WebDriverWait(driver, 5);
						 w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//ul")));
						 ele31.submit();
						 js.executeScript("window.scrollBy(0,100)");
						 List<WebElement> allInputElements = driver.findElements(By.xpath("//h3[contains(text(),'SAP BTP Cloud Workflow and Business Process Management')]"));
				         int y = 1;
						 if ( allInputElements.size() != 0) {
							 //System.out.println("121");
							 for(int y1 = 1; y1 < 3; y1 = y1 + 1){
						    		System.out.println("125");
						    		System.out.print("value of y : " + y1 );
									 elem= driver.findElement(By.xpath("//h3[contains(text(),'SAP BTP Cloud Workflow and Business Process Management')]"));
									 elem.click();
									 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
									 //js.executeScript("window.scrollBy(0,100)");
									 driver.quit();
								 ...
								 System.out.print("value of j : " + j );
								  ...
								  if(allInputElements.size() == 0){
									  for (int i = 0; i < 3; i++) {
										  ...
										  System.out.print("value of i : " + i );
										  js.executeScript("window.scrollBy(0,100)");
										  List<WebElement> allInputElements1 = driver.findElements(By.xpath("//h3[contains(text(),'SAP BTP Cloud Workflow and Business Process Management')]"));
										  System.out.println(allInputElements1.size());
										  if(allInputElements1.size() == 0){
											  System.out.println("hello1");
											  System.out.println(allInputElements1.size());
		...
		static void googlerunhybrid() throws IOException
		  {
			...
			try {
				   ...
				   for(int x = 1; x < 4; x = x + 1) {
						ArrayList<String> readhybridfile = readfile.readhybridkey();
				         ThreadLocalRandom randomhybrid = ThreadLocalRandom.current();
				         int hybrid = randomhybrid.nextInt(0, readhybridfile.size()-1); 
					     System.out.print("value of x : " + x );
				         System.out.print("\n");
						 ...
						 ele31= driver.findElement(By.xpath("//input[contains(@aria-label,'Search')]"));
						 ele31.clear();
						 ele31.sendKeys(readhybridfile.get(hybrid));
						 WebDriverWait w = new WebDriverWait(driver, 5);
						 w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//ul")));
						 ele31.submit();
						 js.executeScript("window.scrollBy(0,100)");
						 List<WebElement> allInputElements = driver.findElements(By.xpath("//h3[contains(text(),'Next Batches - Anubhav Trainings')]"));
				         int y = 1;
						 if ( allInputElements.size() != 0) {
							 //System.out.println("121");
							 for(int y1 = 1; y1 < 3; y1 = y1 + 1){
						    		System.out.println("125");
						    		System.out.print("value of y : " + y1 );
									 elem= driver.findElement(By.xpath("//h3[contains(text(),'Next Batches - Anubhav Trainings')]"));
									 elem.click();
									 driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
									 //js.executeScript("window.scrollBy(0,100)");
									 driver.quit();
								 ...
								 System.out.print("value of j : " + j );
								  ...
								  if(allInputElements.size() == 0){
									  for (int i = 0; i < 3; i++) {
										  ...
										  System.out.print("value of i : " + i );
										  js.executeScript("window.scrollBy(0,100)");
										  List<WebElement> allInputElements1 = driver.findElements(By.xpath("//h3[contains(text(),'Next Batches - Anubhav Trainings')]"));
										  System.out.println(allInputElements1.size());
										  if(allInputElements1.size() == 0){
											  System.out.println("hello1");
											  System.out.println(allInputElements1.size());
